...
class Scannetpp2xDataset(BaseDataset):
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        # info keys: dict_keys([
        #   'sample_idx', 'axis_align_matrix', 'cam2img', 'depth_cam2img',
        #   'images', 'box_type_3d', 'scan_id', 'depth_shift', 'img_path',
        #   'depth_img_path', 'depth2img'
        # ])
        ...
        # ann_info['gt_occupancy'] = gt_occ
        # print(f"gt_occ shape: {gt_occ.shape}") # (?, 4)
        # print(f"gt_occ: {gt_occ[:10]}") # (?, 4)
        # print(f"gt_occ: {gt_occ}")
        # exit()
        ...
        #     # print(occ_masks[i]['visible_occupancy'].shape) # (?, 3)
